...
- `DATA-1` Collect TinyStories dataset and document source (label: data)
...
- `DATA-4` Dataset stats + summary (label: data, docs)
  - Run: `python scripts/compute_dataset_stats.py --input_dir data/raw --dataset tinystories --output docs/dataset_stats.md`
